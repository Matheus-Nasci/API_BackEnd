...
namespace Senai.InLock.WebApi.CodeFirst.Migrations
{
    ...
    [Migration("20200309192132_Cria-Banco")]
            ...
            modelBuilder.Entity("Senai.InLock.WebApi.CodeFirst.Domains.Jogos", b =>
                {
                    ...
                    b.HasData(
                        new { IdJogo = 1, DataLancamento = new DateTime(2012, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), Descricao = "É Um jogo que comtém bastante ação e é viciante", IdEstudio = 1, NomeJogo = "Diablo 3", Valor = 99.00m },
                        new { IdJogo = 2, DataLancamento = new DateTime(2018, 10, 26, 0, 0, 0, 0, DateTimeKind.Unspecified), Descricao = "Jogo eletrônico de Ação e Aventura", IdEstudio = 2, NomeJogo = "Red Dead Redemption II", Valor = 120.00m }
                    );
                });
            ...
            modelBuilder.Entity("Senai.InLock.WebApi.CodeFirst.Domains.TipoUsuario", b =>
                {
                    ...
                    b.HasData(
                        new { IdTipoUsuario = 1, Titulo = "Adminintrador" },
            ...
            modelBuilder.Entity("Senai.InLock.WebApi.CodeFirst.Domains.Usuario", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { IdUsuario = 2, Email = "cliente@cliente.com", IdTipoUsuario = 1, Senha = "cliente" }
                    );
                });

            modelBuilder.Entity("Senai.InLock.WebApi.CodeFirst.Domains.Jogos", b =>
                {
                    b.HasOne("Senai.InLock.WebApi.CodeFirst.Domains.Estudios", "IdEstudioNavigation")
                        .WithMany("Jogos")
